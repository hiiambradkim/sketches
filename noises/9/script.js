...
const SVG = opt => {
	...
	///////////////////////////////////////////////////////////////////////
	const initSVG = opt => {
		if (opt.centerOrigin !== undefined && opt.centerOrigin === true) offset = 1;
		if (opt.cpuTime !== undefined) cpuTime = opt.cpuTime;
		const svgElem = document.querySelector("svg");
		svgElem.setAttribute("viewBox", opt.viewBox || "0 0 100 100");
		svgElem.setAttribute("width", `${opt.size || 300}mm`);
